...
class Usuarios extends CI_Controller {
    ...
    public function edit($usuario_id=null){
        ...
        if(!$usuario_id || !$this->ion_auth->user($usuario_id)->row()){
            ...
            if ($this->form_validation->run()) {
                ...
                if( !$this->core_model->update('users', $data, ['id'=>$usuario_id])){

                    $perfil_usuario_db = $this->ion_auth->get_users_groups($usuario_id)->row();
                    $perfil_usuario_post = $this->input->post('perfil_usuario');               
                    
                    //Se o grupo for diferente actualiza
    ...
    public function email_check($email){
        ...
        if ($this->core_model->getById('users', ['email'=>$email,'id !=' => $usuario_id])) {
            $this->form_valdation->set_message('email_echeck', 'Esse email já existe');
            return false;
        } else {
          return true;
        }
    ...
    public function username_check($username){
        ...
        if ($this->core_model->getById('users', ['username'=>$username,'id !=' => $usuario_id])) {
            $this->form_valdation->set_message('username_check', 'Esse username já existe');
            return false;
        } else {
          return true;
        }
